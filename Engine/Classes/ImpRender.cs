...
public class ImpRender
{
    ...
    public virtual void Draw2D_RectStroke(TVector2i pos, TVector2i size, Color color, float radius, float thickness) {}
...
*/
    // ================================================================================================================
    // 2D IMAGE  (RHI handles the texture lookup + draw — components call this instead of raw AddImage)
    // ================================================================================================================
    public virtual void Draw2D_Image(A_Texture2D? tex, Vector2 pos, Vector2 size, Color tint) {}

    // Legacy texture bridge kept for any code that needs a raw handle
    public virtual nint Texture_ImGuiID(A_Texture2D? tex) => 0;
