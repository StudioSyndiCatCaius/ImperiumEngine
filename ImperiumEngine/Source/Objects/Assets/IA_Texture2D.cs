...
public class IA_Texture2D : ImpAsset
{ 
    ...
    public unsafe IA_Texture2D(string path, TextureType type = TextureType.None)
    {
        _gl = Program.gl;
        Path = path;
        Type = type;
    ...
    public unsafe IA_Texture2D(Span<byte> data, uint width, uint height)
    {
        _gl = Program.gl;
